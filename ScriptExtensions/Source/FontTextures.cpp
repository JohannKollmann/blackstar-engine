...
FontTextures::FontTextures(std::string strFontSpacings)
{
...
Ogre::TexturePtr
FontTextures::CreateTextTexture(std::string strText, int iMaxWidth, int iMaxHeight, int& iActualWidth, int& iActualHeight)
{
...
*/				iCurrLinePos=0;
	...
	iActualHeight++;
	iActualWidth++;
	Ogre::TexturePtr tex = Ogre::TextureManager::getSingleton().createManual(Ogre::String("Ice::FontTexture ") + Ice::SceneManager::Instance().RequestIDStr(),
