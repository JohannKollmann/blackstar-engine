...
public:
	...
	int RegisterTool(Ogre::String toolname, Ogre::String toolgroup, Ogre::String bitmapname, SGTToolCallback callback, Ogre::String tooltip = "", bool checktool = false, bool checked = false);
