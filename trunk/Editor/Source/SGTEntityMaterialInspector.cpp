...
SGTEntityMaterialInspector::SGTEntityMaterialInspector(Ogre::Entity *entity)
{
	mEntity = entity;
}

SGTEntityMaterialInspector::~SGTEntityMaterialInspector(void)
{
}


std::vector<SubMeshInformation*> SGTEntityMaterialInspector::GetSubMeshes(const Ogre::Vector3 &position, const Ogre::Quaternion &orient, const Ogre::Vector3 &scale)
{
...
Ogre::SubEntity* SGTEntityMaterialInspector::GetSubEntity(Ogre::Ray ray)
{
	...
	else Ogre::LogManager::getSingleton().logMessage("Warning: SGTEntityMaterialInspector::GetSubEntity(Ogre::Ray ray) - return NULL");
	for (std::vector<SubMeshInformation*>::iterator mesh = submeshes.begin(); mesh != submeshes.end(); mesh++)
	{
		delete (*mesh);
	}
...
Ogre::String SGTEntityMaterialInspector::GetMaterialName(Ogre::Ray ray)
{
